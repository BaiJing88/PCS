 ...
 * 与 Spigot 插件命令体验一致
 */
public class PCSCommandForge {
    
    private final PCSForgeMod mod;
    
    public PCSCommandForge(PCSForgeMod mod) {
        this.mod = mod;
    }
    ...
    public void register(CommandDispatcher<ServerCommandSource> dispatcher) {
        ...
        dispatcher.register(literal("pcs")
            ...
            .then(literal("help").executes(this::showHelp))
            .then(literal("vote").executes(this::openVoteGUI))
            ...
            .then(literal("banlist").executes(this::showBanlist))
            .then(literal("gui").executes(this::openMainGUI))
        );
        
        // /pcsadmin 管理命令
        dispatcher.register(literal("pcsadmin")
            .requires(source -> source.hasPermissionLevel(4))
            .then(literal("reload").executes(this::reloadConfig))
            .then(literal("debug").executes(this::toggleDebug))
        );
