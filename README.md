...
>
> 本项目（PCS 1.0）已停止更新，不会修复任何BUG或添加新功能。
> 
...
虽然原版 PCS 已停止维护，但社区有了新动向：

### PCS CE (Community Edition)

由 [**明月庄主**](https://space.bilibili.com/2170934?spm_id_from=333.337.0.0) 牵头组织开发的社区版：
